...
public class DateFormatUtils {
	public static final String normal_year="yyyy 年 MM 月 dd 日 ";
	public static final String normal_time="HH 时 mm 分 ";
	/** yyyy:年 */
	...
	public static String getNormalStrTime(Date date,String type){
